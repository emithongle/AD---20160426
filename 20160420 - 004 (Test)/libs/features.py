...
fFeatures = {
    ...
    'bfirst-character-digit': lambda x: (1 if x[0] in string.digits else 0) if len(x) > 0 else 0,
    'bfirst-character-ascii': lambda x: (1 if x[0] in string.ascii_letters else 0) if len(x) > 0 else 0,
    'blast-character-digit': lambda x: (1 if x[-1] in string.digits else 0) if len(x) > 0 else 0,
    'blast-character-ascii': lambda x: (1 if x[-1] in string.ascii_letters else 0) if len(x) > 0 else 0,
